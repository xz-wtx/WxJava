...
1. 公众号 Demo：
	...
	- 使用 `Spring Boot Starter` 实现的公众号 Demo：[GitHub](https://github.com/binarywang/wx-java-mp-demo) [![Build Status](https://travis-ci.org/binarywang/wx-java-mp-demo.svg?branch=master)](https://travis-ci.org/binarywang/wx-java-mp-demo)
